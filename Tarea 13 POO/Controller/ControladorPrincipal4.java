...
public class ControladorPrincipal4 implements MouseListener {
    ...
    private VentanaPrincipal4 view;

    public ControladorPrincipal4(VentanaPrincipal4 view) {
        this.view = view;
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getSource() == this.view.getBtnSaludar()) {
            ...
            System.out.println("Hola desde zacatencop");
        }
