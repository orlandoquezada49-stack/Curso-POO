...
public class VentanaPrincipal3 extends JFrame {
    ...
    public VentanaPrincipal3() {
        super("Intro Mvc prueba 3");
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setLayout(new GridLayout(2, 1));

        panel1 = new JPanel();
        panel1.setBackground(new Color(211, 81, 120));
        panel2 = new JPanel();
        panel2.setBackground(new Color(45, 118, 163, 255));

        lbNombre = new JLabel("Dame Tu Nombre:");
        txtNombre = new JTextField(20);
        btnSaludar = new JButton("Saludos mi estimado");
