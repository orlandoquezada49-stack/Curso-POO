...
public class VentanaPrincipal2 extends JFrame {
    ...
    public VentanaPrincipal2() {
        super("Intro Mvc prueba 2");
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setLayout(new GridLayout(2, 1));

        panel1 = new JPanel();
        panel1.setBackground(new Color(41, 148, 166));
        panel2 = new JPanel();
        panel2.setBackground(new Color(124, 202, 100, 255));

        lbNombre = new JLabel("Dame Tu Nombre cofa:");
